...
/*   Updated: 2019/12/23 17:05:08 by pcredibl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** cycles_to_exec			- время до выполнения операции,
**							на котором стоит каретка
...
** 							- количество проверок без уменьшения парметра
**								cycle_to_die
...
** last_live				- последний cycle когда, команда live указала
							на игрока
** lives_in_period			- кличество операций live совершенное чемпионом
							в текущем цикле (нужно для визуализации)
